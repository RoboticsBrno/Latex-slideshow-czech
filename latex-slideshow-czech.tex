...
\begin{document}
% za procentem muzete psat komentar
% LaTeX vse za procentem ignoruje
Hello world! 
...
\end{document}
	...
	\begin{lstlisting}[language=bettertex]
% pred \begin{document} je potreba vlozit
...
\begin{frame}[fragile]
  ...
  \tableofcontents
	...
	\vfill
	\textit{Pozor, většinou je potřeba přeložit dokument dvakrát, pro zobrazení změn v obsahu. Lze také překladač volat vždy dvakrát (lze nastavit v Texmakeru)}
\end{frame}
...
\begin{frame}[fragile]
	...
	Platí to samé jako pro obsah. Většinou je třeba překládat provést dvakrát.
...
\begin{frame}[fragile]
    ...
    \framesubtitle{5. Citace
    	\footnote{\href{https://github.com/RoboticsBrno/Latex-slideshow-czech/blob/master/support-materials/}{support-materials/ITY5 - Bibliografické citace (BiBTeX, ISO 690).pdf}}    
    }
  ...
  \cite{jmeno_citace}
	...
	\begin{enumerate}[a)]
		...
		\item nástrojem \hologo{BibTeX}\footnote{\url{http://www.fit.vutbr.cz/~martinek/latex/bibtex.html}}
	\end{enumerate}
...
\begin{frame}[fragile]
    \frametitle{Výhody \LaTeX{\lower .5ex\hbox {U}}}
    \framesubtitle{7. Odkazy v textu\footnote{\url{https://en.wikibooks.org/wiki/LaTeX/Hyperlinks}}
  ...
  \pageref{jmeno_objektu}
  
  % klikatelna webova adresa
  \url{https://vase_url_adresa.cz}
  
  % klikatelny text na webovou stranku
  \href{http://www.robotikabrno.cz}{RobotikaBrno}
    \end{lstlisting}   
...
\begin{frame}[fragile]
    \frametitle{Výhody \LaTeX{\lower .5ex\hbox {U}}}
    \framesubtitle{8. Vkládání matematiky (1)}

	\LaTeX{\lower .5ex\hbox {U}} je nejmocnější nástroj na práci se vzorci.	

	\begin{lstlisting}[language=bettertex]
  $a^2+b^2=c^2$ 
  % $ - pro vkladani matematiky primo do textu
	\end{lstlisting}
    ...
    \begin{lstlisting}[language=bettertex]
  % samostatna necislovana rovnice
  \begin{equation*}
...
\begin{frame}[fragile]
    \frametitle{Výhody \LaTeX{\lower .5ex\hbox {U}}}
    \framesubtitle{8. Vkládání matematiky (2)}
	Nečíslovaná rovnice:
	\begin{equation*}
...
\begin{frame}[fragile]
    \frametitle{Výhody \LaTeX{\lower .5ex\hbox {U}}}
    \framesubtitle{9. Číslování stran 
    	\footnote{\href{https://github.com/RoboticsBrno/Latex-slideshow-czech/blob/master/support-materials/}{support-materials/ITY3 - Strukturování dokumentů...}}
    	\footnote{\url{https://en.wikibooks.org/wiki/LaTeX/Counters}}
    }
...
\begin{frame}[fragile]
    ...
    \end{itemize}
    Dobrý grafický styl pro prezentaci je \href{https://cs.sharelatex.com/blog/2013/08/14/beamer-series-pt2.html}{Beamer}.
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
    	\item \LaTeX{ }lze verzovat\footnote{\url{https://github.com}}
...
\begin{frame}[fragile]
    ...
    Zajímavé odkazy:
    \begin{itemize}
    	\item \href{http://www.fit.vutbr.cz/~martinek/latex/index.html#02}{LaTEXové speciality}
    	\item \href{http://ftp.cvut.cz/tex-archive/macros/latex/contrib/booktabs/booktabs.pdf}{Pěknější tabulky pomocí Booktabs}
    	\item \href{http://detexify.kirelabs.org/classify.html}{Nevíte jak vysázet nějaký znak - namalujte jej :-)}
     	\item \href{https://www.overleaf.com/latex/examples/tikz-flowchart-of-an-epidemiology-study/hdpqksvwkqdm#.WBt1UujhCM9}{Bloková schemata s balíkem TikZ}
     	\item \href{http://www.texample.net/tikz/examples/}{Zajímavá infografika s TikZ}	   
     	\item \href{https://www.overleaf.com/}{Webový \LaTeX{}překladač}	   
     	\item \href{http://www.zinktypografie.nl/latex.php?lang=en}{Kde je \LaTeX{}lepší než Word}	   
     	\item \href{https://www.youtube.com/user/ShareLaTeX/videos}{Zajímavé video návody}	
     	\item Jak tvořit pěkné prezentace: 
     		\href{https://designshack.net/articles/graphics/how-to-design-a-professional-powerpoint-presentation/}{odkaz 1,}
     		\href{https://www.proofhq.com/blog-marketing/10-tips-for-designing-presentations-that-dont-suck-pt-1-007623/}{odkaz 2}
...
\begin{frame}[fragile]
	...
	\begin{figure}[H]
        \includegraphics[width=190px]{img/jcmm-logotype-positive-orez.png}
	\end{figure}

	\begin{figure}[H]
        \includegraphics[width=190px]{img/robotarna_napis.jpg}
	\end{figure}

		
        {\huge \href{www.RobotikaBrno.cz}{www.robotikabrno.cz}}
